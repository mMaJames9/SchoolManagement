    ...
    return (function() {
                ...
                var dayjs_min = createCommonjsModule(function(t, n) {
                    t.exports = function() {
                        ...
                        var v = function() {
                            ...
                            ,
                            d.$set = function(s, a) {
                                var h, f = g.p(s), c = "set" + (this.$u ? "UTC" : ""), d = (h = {},
                                h[i] = c + "Date",
                                h.date = c + "Date",
                                h[o] = c + "Month",
                                h[u] = c + "FullYear",
                            ...
                            d.diff = function(t, h, f) {
                                var c, d = g.p(h), l = y(t), m = 6e4 * (l.utcOffset() - this.utcOffset()), $ = this - l, M = g.m(this, l);
                                return M = (c = {},
                                c[u] = M / 12,
                                c[o] = M,
                                c[a] = M / 3,
                        ...
                        return y.prototype = v.prototype,
                  ...
                  , customParseFormat = createCommonjsModule(function(t, n) {
                    ...
                    t.exports = (r = /(\[[^[]*\])|([-:\/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,
                    o = /\d*[^\s\d-:\/.()]+/,
                    u = [/[+-]\d\d:?\d\d/, function(t) {
                        var n, e;
                        (this.zone || (this.zone = {})).offset = (n = t.match(/([+-]|\d\d)/g),
                    ...
                    f = function(t, n, e) {
                        try {
                            var i = function(t) {
                              ...
                              , l = i.zone;
                            if (l)
                                return new Date(Date.UTC(s, o - 1, a, u || 0, f || 0, c || 0, d || 0) + 60 * l.offset * 1e3);
                            var m = new Date
                              , $ = s || m.getFullYear()
                    ...
                    function(t, n, r) {
                        ...
                        i.parse = function(t) {
                            var n = t.date
                              ...
                              , a = t.utc;
                            this.$u = a,
                            i ? (e = o ? r.Ls[o] : this.$locale(),
                            this.$d = f(n, i, a),
                            this.init(t)) : s.call(this, t)
                        }
                    }
                    )
                });
        ...
        2: [function(require, module, exports) {
            ...
            class Rows {
                ...
                remove(t) {
                    const e = this.dt;
                    Array.isArray(t) ? (t.sort((t,e)=>e - t),
                    t.forEach(t=>{
                        e.data.splice(t, 1)
                    }
            ...
            class Columns {
                ...
                order(t) {
                    ...
                    t.forEach((t,a)=>{
                        ...
                        e.sortable = l,
                        h[0].push(e),
                        o.hiddenColumns.includes(t) || ((s = n.cloneNode(!0)).originalCellIndex = a,
                        s.sortable = l,
                        h[1].push(s))
                    }
                    ),
                    o.data.forEach((e,s)=>{
                        ...
                        t.forEach(t=>{
                            ...
                            a.appendChild(r),
                            o.hiddenColumns.includes(t) || ((r = e.cells[t].cloneNode(!0)).data = e.cells[t].data,
                            i.appendChild(r))
                        }
                        ),
                        h[2].push(a),
                ...
                visible(t) {
                    let e;
                    const s = this.dt;
                    return t = t || s.headings.map(t=>t.originalCellIndex),
                    isNaN(t) ? Array.isArray(t) && (e = [],
                    t.forEach(t=>{
                ...
                add(t) {
                    ...
                    this.dt.data.forEach((s,a)=>{
                        t.data[a] && (e = document.createElement("td"),
                        t.data[a].nodeName ? e.appendChild(t.data[a]) : e.innerHTML = t.data[a],
                        e.data = e.innerHTML,
                    ...
                    t.hasOwnProperty("sortable") && (s.sortable = t.sortable,
                ...
                remove(t) {
                    Array.isArray(t) ? (t.sort((t,e)=>e - t),
                    t.forEach(t=>this.remove(t))) : (this.dt.headings.splice(t, 1),
                ...
                sort(t, e, s) {
                    ...
                    if ("date" === d.getAttribute("data-type")) {
                        let t = !1;
                        d.hasAttribute("data-format") && (t = d.getAttribute("data-format")),
                        c.push(new Promise(function(t) {
                    ...
                    Promise.all(c).then(i=>{
                        ...
                        Array.from(n).forEach(e=>{
                            const s = e.cells[t]
                              , a = s.hasAttribute("data-content") ? s.getAttribute("data-content") : s.innerText;
                            let i;
                            i = c ? c(a) : "string" == typeof a ? a.replace(/(\$|,|\s|%)/g, "") : a,
                            parseFloat(i) == i ? r[o++] = {
                                value: Number(i),
                                row: e
                            } : l[h++] = {
                        ...
                        "desc" == e ? (p = sortItems(l, -1),
                        u = sortItems(r, -1),
                        d.classList.remove("asc"),
                        d.classList.add("desc")) : (p = sortItems(r, 1),
                        u = sortItems(l, 1),
                        d.classList.remove("desc"),
                        d.classList.add("asc")),
                        a.lastTh && d != a.lastTh && (a.lastTh.classList.remove("desc"),
                ...
                rebuild() {
                    ...
                    i.data.forEach((l,r)=>{
                        ...
                        null !== l.searchIndex && void 0 !== l.searchIndex && (t.searchIndex = e.searchIndex = l.searchIndex),
                        Array.from(l.cells).forEach(n=>{
                            (s = n.cloneNode(!0)).data = n.data,
                            t.appendChild(s),
                            i.hiddenColumns.includes(s.cellIndex) || ((a = s.cloneNode(!0)).data = s.data,
                            e.appendChild(a))
                        }
                        ),
                        n.push(t),
            ...
            const dataToTable = function(t) {
                ...
                t.data && t.data.length && (s = createElement("tbody"),
                t.data.forEach(e=>{
                ...
                e && (null !== this.table.tHead && this.table.removeChild(this.table.tHead),
                this.table.appendChild(e)),
                s && (this.table.tBodies.length && this.table.removeChild(this.table.tBodies[0]),
            ...
            class DataTable {
                ...
                render(t) {
                    ...
                    let s = "";
                    if (e.data && dataToTable.call(this),
                    e.ajax) {
                        const t = e.ajax
                          ...
                          , i = e=>{
                            if (4 === s.readyState)
                                if (this.emit("datatable.ajax.loaded", e, s),
                                200 === s.status) {
                                    const a = {};
                                    a.data = t.load ? t.load.call(this, s) : s.responseText,
                                    a.type = "json",
                                    t.content && t.content.type && (a.type = t.content.type,
                                    Object.assign(a, t.content)),
                                    this.import(a),
                                    this.setColumns(!0),
                                    this.emit("datatable.ajax.success", e, s)
                                } else
                                    this.emit("datatable.ajax.error", e, s)
                        }
                          , n = t=>{
                    ...
                    this.body || (this.body = createElement("tbody"),
                    ...
                    e.footer ? this.head && !this.foot && (this.foot = createElement("tfoot", {
                    ...
                    s += e.layout.bottom,
                    s = (s += "</div>").replace("{info}", e.paging ? "<div class='dataTable-info'></div>" : ""),
                    e.paging && e.perPageSelect) {
                        let t = "<div class='dataTable-dropdown'>";
                        t += e.labels.perPage,
                        t += "<label>enregistrements par page</label></div>";
                ...
                renderPage() {
                    if (this.hasHeadings && (flush(this.header),
                    ...
                    let t, e = 0, s = 0, a = 0;
                    if (this.totalPages && (a = (s = (e = this.currentPage - 1) * this.options.perPage) + this.pages[e].length,
                    s += 1,
                ...
                renderPager() {
                    if (flush(this.pagers),
                    this.totalPages > 1) {
                        const t = "pager"
                          , e = document.createDocumentFragment()
                          , s = this.onFirstPage ? 1 : this.currentPage - 1
                          , a = this.onLastPage ? this.totalPages : this.currentPage + 1;
                        this.options.firstLast && e.appendChild(button(t, 1, this.options.firstText)),
                        this.options.nextPrev && e.appendChild(button(t, s, this.options.prevText));
                        let i = this.links;
                        this.options.truncatePager && (i = truncate(this.links, this.currentPage, this.pages.length, this.options.pagerDelta, this.options.ellipsisText)),
                        ...
                        this.links[this.currentPage - 1].classList.add("active"),
                        this.options.nextPrev && e.appendChild(button(t, a, this.options.nextText)),
                        this.options.firstLast && e.appendChild(button(t, this.totalPages, this.options.lastText)),
                ...
                renderHeader() {
                    ...
                    this.headings && this.headings.length && this.headings.forEach((t,e)=>{
                        if (this.labels[e] = t.textContent,
                ...
                bindEvents() {
                    ...
                    t.searchable && (this.input = this.wrapper.querySelector(".dataTable-input"),
                    this.input && this.input.addEventListener("keyup", ()=>this.search(this.input.value), !1)),
                    this.wrapper.addEventListener("click", e=>{
                        const s = e.target;
                        "a" === s.nodeName.toLowerCase() && (s.hasAttribute("data-page") ? (this.page(s.getAttribute("data-page")),
                        e.preventDefault()) : t.sortable && s.classList.contains("dataTable-sorter") && "false" != s.parentNode.getAttribute("data-sortable") && (this.columns().sort(this.headings.indexOf(s.parentNode)),
                        e.preventDefault()))
                    }
                    , !1),
                ...
                setColumns(t) {
                    ...
                    this.options.columns && this.headings.length && this.options.columns.forEach(t=>{
                        ...
                        t.hasOwnProperty("render") && "function" == typeof t.render && (this.selectedColumns = this.selectedColumns.concat(t.select),
                ...
                paginate() {
                    ...
                    return this.searching && (e = [],
                    this.searchData.forEach(t=>e.push(this.activeRows[t]))),
                    this.options.paging ? this.pages = e.map((s,a)=>a % t == 0 ? e.slice(a, a + t) : null).filter(t=>t) : this.pages = [e],
                ...
                fixColumns() {
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        this.table.tHead) {
                            if (this.options.scrollY.length && ((e = createElement("thead")).appendChild(createElement("tr")),
                            e.style.height = "0px",
                ...
                search(t) {
                    return !!this.hasRows && (t = t.toLowerCase(),
                    this.currentPage = 1,
                    this.searching = !0,
                    this.searchData = [],
                    t.length ? (this.clear(),
                ...
                page(t) {
                    return t != this.currentPage && (isNaN(t) || (this.currentPage = parseInt(t, 10)),
                    !(t > this.pages.length || t < 0) && (this.render("page"),
                    this.render("pager"),
                ...
                export(t) {
                    ...
                    if (h.type) {
                        if ("txt" !== h.type && "csv" !== h.type || (s[0] = this.header),
                        h.selection)
                            if (isNaN(h.selection)) {
                                ...
                                s = s.concat(this.pages[h.selection - 1]);
                        else
                        ...
                        if (s.length) {
                            if ("txt" === h.type || "csv" === h.type) {
                                ...
                                for (l = `INSERT INTO \`${h.tableName}\` (`,
                                i = 0; i < e.length; i++)
                                    !h.skipColumn.includes(e[i].originalCellIndex) && this.columns(e[i].originalCellIndex).visible() && (l += `\`${e[i].textContent}\`,`);
                                for (l = l.trim().substring(0, l.length - 1),
                                l += ") VALUES ",
                                i = 0; i < s.length; i++) {
                                    for (l += "(",
                                    n = 0; n < s[i].cells.length; n++)
                                        !h.skipColumn.includes(e[n].originalCellIndex) && this.columns(e[n].originalCellIndex).visible() && (l += `"${s[i].cells[n].textContent}",`);
                                    l = l.trim().substring(0, l.length - 1),
                                    l += "),"
                                }
                                l = l.trim().substring(0, l.length - 1),
                                l += ";",
                                h.download && (l = `data:application/sql;charset=utf-8,${l}`)
                            } else if ("json" === h.type) {
                                for (n = 0; n < s.length; n++)
                                    for (a[n] = a[n] || {},
                                    i = 0; i < e.length; i++)
                                        !h.skipColumn.includes(e[i].originalCellIndex) && this.columns(e[i].originalCellIndex).visible() && (a[n][e[i].textContent] = s[n].cells[i].textContent);
                                l = JSON.stringify(a, h.replacer, h.space),
                                h.download && (l = `data:application/json;charset=utf-8,${l}`)
                            }
                            return h.download && (h.filename = h.filename || "datatable_export",
                            h.filename += `.${h.type}`,
                            l = encodeURI(l),
                ...
                import(t) {
                    ...
                    if (s.data.length || isObject(s.data)) {
                        if ("csv" === s.type) {
                            ...
                            t.length && (s.headings && (e.headings = t[0].split(s.columnDelimiter),
                            t.shift()),
                            t.forEach((t,a)=>{
                                e.data[a] = [];
