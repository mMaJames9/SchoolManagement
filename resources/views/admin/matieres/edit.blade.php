                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group form-group-default required">
                                ...
                                <input type="text" class="form-control @error('forme_evaluation') is-invalid @enderror" placeholder="Forme d'évaluation de la compétence"  value="{{ old('forme_evaluation', $competence->matieres[0]->forme_evaluation) }}" id="forme_evaluation" name="forme_evaluation" required>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group form-group-default required">
                                ...
                                <input type="number" min="1" value="{{ old('notation_matiere', $competence->matieres[0]->notation_matiere) }}" class="form-control @error('notation_matiere') is-invalid @enderror" placeholder="Total de la forme d'évaluation" id="notation_matiere" name="notation_matiere" required>
