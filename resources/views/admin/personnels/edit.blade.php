                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group form-group-default required">
                                ...
                                <input type="month" class="form-control @error('experience_personnel') is-invalid @enderror" id="experience_personnel" value="{{ old('experience_personnel', $personnel->experience_personnel) }}" placeholder="Nombre d'années d'expérience de l'employé" name="experience_personnel" required>
