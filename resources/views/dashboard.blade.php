                                            ...
                                            <div class="col-sm-6">
                                                <div class="p-l-20">
                                                    ...
                                                    <p class="small hint-text m-t-5">
                                                        <span class="label  font-montserrat m-r-5">60%</span>
                                                        Higher
                                                    </p>
                                                </div>
                                            </div>
                ...
                <div class="widget-15 card card-condensed  no-margin no-border widget-loader-circle">
                    ...
                    <div class="card-body no-padding">
                        <ul class="nav nav-tabs nav-tabs-simple">
                            ...
                            <li class="nav-item">
                                <a href="#" data-toggle="tab" class="p-t-5">
                                    FB<br>
                                    45.97<br>
                        ...
                        <div class="tab-content p-l-20 p-r-20">
                            ...
                            <div class="tab-pane no-padding" id="widget-15-tab-2"></div>
                            <div class="tab-pane" id="widget-15-tab-3"></div>
                        </div>
                    ...
                    <div class="container-sm-height no-overflow">
                        <div class="row row-sm-height">
                            <div class="col-sm-5 col-lg-4 col-xlg-3 col-sm-height col-top no-padding">
                                <div class="card-header  ">
                                    <div class="card-title">Menu clipping</div>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="bg-master-light p-l-20 p-r-20 p-t-10 p-b-10 pull-bottom full-width hidden-xs">
                                    <p class="no-margin">
                                        <a href="#">
                                            <i class="fa fa-arrow-circle-o-down text-success"></i>
                                        </a>
        ...
        <div class="row">
            <div class="col-lg-4 visible-lg hidden-xlg sm-m-b-10">
                ...
                <div class="widget-15-2 card no-margin no-border widget-loader-circle">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane no-padding" id="widget-15-2-tab-2"></div>
                        <div class="tab-pane" id="widget-15-2-tab-3"></div>
                    </div>

                    <div class="p-t-10 p-l-20 p-r-20 p-b-30">
                        <div class="row">
                            <div class="col-md-9">
                                <p class="fs-16 text-black">Apple’s Motivation - Innovation distinguishes between A leader and a follower.</p>
            ...
            <div class="col-md-4 col-lg-3 col-xlg-3 m-b-10 visible-xlg">
                ...
                <div class="widget-16 card no-border  no-margin widget-loader-circle">
                    <div class="card-header ">
                        <div class="card-title">Page Options</div>
                        <div class="card-controls">
                            <ul>
                                <li>
                                    <a href="#" class="card-refresh text-black" data-toggle="refresh">
                        ...
                        <div class="card no-border  no-margin">
                            ...
                            <div class="padding-15">
                                ...
                                <ul class="list-inline pull-right no-margin">
                                    <li>
                                        <a class="text-master hint-text" href="#">5,345
                                            <i class="fa fa-comment-o"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="text-master hint-text" href="#">23K
                                            <i class="fa fa-heart-o"></i>
                                        </a>
                                    </li>
                                </ul>
